...
function TaskCard({ title, desc, priority, pin, due }) {
    return (
        <div
            className='flex  flex-col gap-2.5 p-1 transition-all duration-150 cursor-pointer  border-3  border-red  h-50 w-80 bg-[#1F1F1F]  border-[#1F1F1F] rounded-md hover:scale-105 '
        >
            ...
            >
                ...
                <p
                    className={`text-xs font-bold ${
                        priority.toLowerCase() == "high" ? "text-red-500" :
